...
import frc.robot.subsystems.drive.ModuleIOSparkHybrid;
    ...
    switch (Constants.currentMode) {
      case REAL:
        ...
        drive =
            new Drive(
                new GyroIOPigeon2(),
                new ModuleIOSparkHybrid(0),
                new ModuleIOSparkHybrid(1),
                new ModuleIOSparkHybrid(2),
                new ModuleIOSparkHybrid(3));
        break;

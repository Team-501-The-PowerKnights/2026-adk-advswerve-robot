...
public class LauncherFOC extends TalonFXSubsystem implements ISubsystem {
  ...
  public LauncherFOC() {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Play Indiana Jones theme on the motors if you can get it working. You will need to create a
    // .chrp file with the music and put it in the deploy directory. Then you can load and play it
    // with the code below. Note that loading the music may take a few seconds, so you might want to
    // do it asynchronously or during initialization.
  ...
  private void logMotorTelemetry() {
    ...
    Logger.recordOutput(
        getSubsystem() + "/isLeaderNearTarget",
        leader.getVelocity().isNear(axleTargetRps * 2, 0.5));
  }
